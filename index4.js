...
backIcon.setAttribute("class","fas fa-arrow-alt-circle-left");
...
const mainBox = document.querySelector("#new-box");

let task = obj[i].name;
document.getElementById('newTrip').innerHTML=task;
...
addIcon.setAttribute("class","fas fa-plus-square");
addIcon.innerHTML="";
...
taskAdd.appendChild(addIcon);
		...
		taskDelete.addEventListener('click', (e) => {
			...
			mainBox.style.setProperty('background-color','black');
